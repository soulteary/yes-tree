 ...
 *
 * @param cwd       {string}            target dir;
 * @param json      {boolean}           whether the value is `true`, you'll get json;
 * @param depth     {int}               max depth, limit 30, default 30;
 * @param exclude   {object}            exclude options;
 ...
 * @param silent    {boolean}           hide error message, default true;
 *
 * @see directoryTreeObject inspire https://github.com/mihneadb/node-directory-tree
 */
